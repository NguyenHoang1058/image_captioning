...
def main():
    ...
    print("Đang khởi tạo mô hình ATTENTION...")
    encoder = EncoderAttention().to(device)
    decoder = DecoderAttention(embed_size, vocab_size, attention_dim=256, encoder_dim=2048, decoder_dim=512).to(device)
    ...
    for epoch in range(1, num_epochs + 1):
        # Gọi hàm train_epoch bạn đã viết ở src/training/train.py
